      ...
      {modal === 'ledger' && (
        <Modal title={selected.name + ' — Ledger'} onClose={() => setModal(null)}>
          <div className="space-y-1.5">
            ...
            {ledger.map(l => (
              <div key={l.id} className="flex items-center justify-between text-sm border-b border-gray-50 py-2">
                <div>
                  <p className="capitalize font-medium text-gray-700">{l.type}</p>
